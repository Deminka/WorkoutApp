...
extension OverviewController {
    ...
    override func configureAppearance() {
        ...
        dataSource = [
            .init(date: Date(),
                  items: [.init(title: "Warm Up Cardio", subtitle: "Treadmill • 10 minutes", isDone: true),
                               .init(title: "High Intensity Cardio", subtitle: "Treadmill • 50 minutes", isDone: false)
                  ]),
            .init(date: Date(),
                  items: [.init(title: "Warm Up Cardio", subtitle: "Treadmill • 10 minutes", isDone: false),
            ...
            .init(date: Date(),
                  items: [.init(title: "Cardio Interval Workout", subtitle: "Treadmill • 60 minutes", isDone: false)
                              ])
        ]
